                ...
                <div
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div class="mt-5 flex justify-center sm:justify-start gap-4">
    <a href="{{ route('login') }}"
       class="inline-block px-6 py-2 text-sm font-medium text-white bg-brand-500 rounded-lg shadow-md hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 dark:bg-brand-400 dark:hover:bg-brand-500 transition">
        Login
    </a>

    <a href="{{ route('register') }}"
       class="inline-block px-6 py-2 text-sm font-medium text-brand-600 bg-white border border-brand-500 rounded-lg shadow-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 dark:bg-gray-800 dark:text-brand-400 dark:border-brand-400 dark:hover:bg-gray-700 transition">
        Register
    </a>
</div>
