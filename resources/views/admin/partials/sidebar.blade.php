    ...
    <div class="flex flex-col overflow-y-auto no-scrollbar duration-300 ease-linear">
            ...
            <div>
                ...
                {{ Request::is('/')
                  ...
                  : 'text-black dark:text-white hover:text-blue-600 dark:hover:text-blue-400' }}">
                    ...
                    {{ Request::is('/')
                      ? 'text-blue-600 dark:text-white'
                      : 'text-black dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400' }}"></i>
      ...
      {{ request()->routeIs('admin.tools.*')
        ...
        : 'text-black dark:text-white hover:text-blue-600 dark:hover:text-blue-400' }}">
                            <div class="flex items-center gap-2">
                                <i
                                    class="fa-solid fa-screwdriver-wrench text-base
          {{ request()->routeIs('admin.tools.*')
            ? 'text-blue-600 dark:text-white'
            : 'text-black dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400' }}"></i>
                                <span :class="sidebarToggle ? 'lg:hidden' : ''">Tools</span>
                            </div>
                        </a>
                    </li>
